...
class AppStore extends Component {
  ...
  render() {
    ...
    const searchResult = updatedAppList.filter(eachApp =>
        ...
        <div className="card">
          ...
          <div className="input-card">
            <input
              ...
              placeholder="Search"
              value={searchInput}
              onChange={this.isSearchInputEntered}
            />
          ...
          <ul className="ul-app-card">
            {searchResult.map(appObj => (
              <Apps appDetails={appObj} key={appObj.appId} />
            ))}
          </ul>
        </div>
      </div>
